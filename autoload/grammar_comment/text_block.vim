...
function grammar_comment#text_block#get_blocks(buf_lines, file_name, extension)
	...
	elseif a:extension == 'md'
		let l:blocks = grammar_comment#markdown#functions#get_blocks(a:buf_lines)
	...
	elseif a:extension == 'tex' || a:extension == 'latex'
		let l:blocks = grammar_comment#latex#functions#get_blocks(a:buf_lines)
